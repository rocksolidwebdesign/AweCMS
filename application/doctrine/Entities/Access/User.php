 ...
 */
class User extends \Entities\AbstractEntity
{
    /**
    ...
    /**
     * @ManyToMany(targetEntity="\Entities\Access\Group", inversedBy="users")
    ...
    /**
     * @OneToMany(targetEntity="\Entities\Premium\Subscription", mappedBy="user")
     * @awe:AutoFormElement(
     *     label="Subscriptions",
     *     edit_inline=1
     * )
