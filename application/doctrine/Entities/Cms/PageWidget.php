 ...
 */
class PageWidget extends \Entities\AbstractEntity
{
    /**
    ...
    /**
     * @ManyToOne(targetEntity="\Entities\Cms\Page", inversedBy="widgets")
    ...
    /**
     * @ManyToOne(targetEntity="\Entities\Cms\Widget", inversedBy="pages")
